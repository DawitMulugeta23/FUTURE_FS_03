    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <p className="text-gray-700 leading-relaxed text-lg">
          Located in the heart of Debre Berhan, **Yesekela Café** has been a sanctuary for students and coffee lovers alike. 
          We believe that a great day starts with a perfect roast and a warm community. 
          Our platform was designed to bring our authentic flavors directly to your fingertips.
        </p>
