    ...
    <div className="min-h-screen flex items-center justify-center bg-coffee-50 py-12 px-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-playfair font-bold text-coffee-800">Welcome Back</h1>
        ...
        <p className="text-center text-gray-600 mt-6">
          ...
          <Link to="/register" className="text-coffee-500 hover:text-coffee-600 font-semibold">
            Sign Up
          </Link>
        </p>
      </motion.div>
