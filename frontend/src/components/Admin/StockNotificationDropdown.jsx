// frontend/src/components/Admin/StockNotificationDropdown.jsx
import { AlertCircle, Edit3, Package, TrendingDown } from "lucide-react";
import { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { useTheme } from "../../context/useTheme";

const StockNotificationDropdown = ({ onClose }) => {
            ...
            {outOfStockItems.map((item) => (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-bold text-red-500">0 left</span>
                </div>
              </button>
            ))}
          </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-xs font-bold ${
                      item.quantity <= 2 ? "text-red-500" : "text-yellow-500"
                    }`}
                  >
                    {item.quantity} left
                  </span>
